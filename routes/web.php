...
//Route::match(['get', 'post'],'/webhook', 'BotController@webhook');
...
Route::get('/auth/login',
	['uses' => '\OrionMedical\Http\Controllers\AuthController@getSignin',
	 ...
	 Route::get('/auth/mobile',
	 ['uses' => '\OrionMedical\Http\Controllers\AuthController@getSigninMobile',
	  'as' => 'auth.mobile',  
	  ]);
...
Route::get('/create-patient', 
	...
	Route::get('/create-patient-tab', 
	['uses' => '\OrionMedical\Http\Controllers\KYCController@postNewCustomerTab',
	'as' => 'create-patient-tab',]);
...
Route::get('/print-visit-summary/{id}', 
	...
	Route::get('/print-visit-summary-dental/{id}', 
	['uses' => '\OrionMedical\Http\Controllers\DoctorController@printVisitSummaryDental', 
	'as' => 'print-visit-summary-dental', ]);
...
Route::get('/payment-index',
	['uses' => '\OrionMedical\Http\Controllers\BillController@payments',
	 ...
	 Route::get('/reverse-payment',
	['uses' => '\OrionMedical\Http\Controllers\BillController@reversePayment',
	 'as' => 'reverse-payment', ]);
...
Route::get('/billing-dashboard',
	['uses' => '\OrionMedical\Http\Controllers\BillController@dashboard',
	 ...
	 ['uses' => '\OrionMedical\Http\Controllers\BillController@fetchbillTotal',
	 'as' => 'billing-total',]);
...
Route::get('/laboratory-results/{id}/{category}',
...
Route::get('/laboratory-biochemistry/{id}',
	['uses' => '\OrionMedical\Http\Controllers\LabController@printResultsBio',
	 ...
	 Route::get('/laboratory-pathology/{id}',
	 ['uses' => '\OrionMedical\Http\Controllers\LabController@printResultsPath',
	  'as' => 'laboratory-pathology', ]);

	  Route::get('/laboratory-serology/{id}',
	['uses' => '\OrionMedical\Http\Controllers\LabController@printResultsSero',
	 'as' => 'laboratory-serology', ]);
...
Route::post('/add-body-result', 
	...
	Route::get('/laboratory-results-master/{id}',
	['uses' => '\OrionMedical\Http\Controllers\LabController@printResultsMaster',
	 'as' => 'laboratory-results-master', ]);
...
Route::get('/update-drug-quantity', 
	...
	Route::get('/update-discount-value', 
	['uses' => '\OrionMedical\Http\Controllers\BillController@discountInvoiceItem',
	'as' => 'update-discount-value',]);
...
Route::get('/patient-investigation-results', 
['uses' => '\OrionMedical\Http\Controllers\DoctorController@getInvestigationResults',
'as' => 'patient-investigation-results',]);
...
Route::get('/add-medication', 
	...
	Route::get('/add-medication-extra', 
	['uses' => '\OrionMedical\Http\Controllers\DoctorController@addMedicationExtra',
	'as' => 'add-medication-extra',]);
