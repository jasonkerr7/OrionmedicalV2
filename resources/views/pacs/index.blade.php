                              ...
                              <div class="tab-content">
                                  <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                                                  ...
                                                                  @foreach($imagerequests as $lab)
                                                                    <tr>
                                                                      ...
                                                                      <td>
                                                                        ...
                                                                        <a href="/upload-scan/{{ $lab->visitid }}" ><span class="btn btn-sm btn-danger ml-50"> Not Ready </span></a>
                                                                        @elseif (str_contains($lab->status, ['Pending','Ready']) !== FALSE)
                                                                        <a href="/upload-scan/{{ $lab->visitid }}" ><span class="btn btn-sm btn-success ml-50">  Ready </span></a>
                                                                        @endif
                                                                      </td>
                                                                    </tr>
                                                                  @endforeach
                                    ...
                                    <div class="row">
                                      ...
                                      <div> Record(s) Found : {{ $imagerequests->total() }} {{ str_plural('Request', $imagerequests->total()) }}</div>
                                    </div>
