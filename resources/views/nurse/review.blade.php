...
<section class="vbox">
           <header class="header bg-white b-b b-light">
                     ...
                     <a href="#"  class="btn btn-info btn-s-md btn-lg">{{ $visit_details->care_provider }} ({{  $patients[0]->insurance_cover }})</a> ||
              ...
              <section class="hbox stretch">
                ...
                <aside class="bg-white">
                  ...
                  <header class="header bg-white b-b b-light">
                   ...
                   <a href="#new-admission"  data-toggle="modal" class="btn btn-sm btn-dark bootstrap-modal-form-open pull-right"> <i class="fa fa-plus"></i> Admit Patient to Ward </a>
                   @else
                   
                   <a href="#new-admission-duplicate"  data-toggle="modal" class="btn btn-sm btn-warning bootstrap-modal-form-open pull-right"> <i class="fa fa-plus"></i> Submit New Entry </a>
                   @endif
                 ...
                 {{--     <a href="#new-discharge"  data-toggle="modal" class="btn btn-sm btn-warning bootstrap-modal-form-open pull-right"> <i class="fa fa-plus"></i> Discharge Patient </a> --}}
                         ...
                         @if($visit_details->billable=='Inpatient')
                          ...
                          <p class="block pull-left"><a href="#" class=""></a> <span class="btn btn-default btn-s-md btn-sm">Admission Type : {{ $visit_details->ward_admission_type}} </span></p>
   
                         <p class="block pull-left"><a href="#" class=""></a> <span class="btn btn-default btn-s-md btn-sm">Ward : {{ $visit_details->ward_id}} </span></p>
   
                         <p class="block pull-left"><a href="#" class=""></a> <span class="btn btn-default btn-s-md btn-sm">Bed : {{ $visit_details->bed_id}}</span></p>
   
                          <p class="block pull-left"><a href="#" class=""></a> <span class="btn btn-default btn-s-md btn-sm">Admission Time : {{ $visit_details->ward_admission_time}}</span></p>
                         @else
                         <p class="block pull-left"><a href="#" class=""></a> <span class="btn btn-default btn-s-md btn-sm">Admission Type : {{ $visit_details->consultation_type}} </span></p>
                         @endif
                           </span>
                      ...
                      <ul class="nav nav-tabs nav-white">
                         ...
                         <li class=""><a href="#history-summary" data-toggle="tab"><i class="fa fa-archive text-default"></i> Notes History (Old Visits) </a></li>
                          ...
                          <li class=""><a href="#review-diagnosis" data-toggle="tab"><i class="fa fa-gavel text-default"></i> Diagnosis </a></li>
                            ...
                            <li class=""><a href="#review-operation" data-toggle="tab"><i class="fa fa-table text-default"></i> Operation/Surgery Notes </a></li>
                            <li class=""><a href="#review-medication" data-toggle="tab"><i class="fa fa-flask text-default"></i> Drug Administration </a></li>

                            @role(['Nurse','System Admin','Nurse Assistant'])
...
function loadMedication()
   {
        ...
        $.get('/patient-medication',
          ...
          { 
            ...
            $.each(data, function (key, value) 
            {           
            $('#drugTable tbody').append('<tr><td>'+ value['drug_quantity'] +'</td><td>'+ value['drug_name'] +'</td><td>'+ value['drug_application'] +'</td><td>'+ value['created_by'] +'</td><td>'+ value['created_on'] +'</td></tr>');
            });
