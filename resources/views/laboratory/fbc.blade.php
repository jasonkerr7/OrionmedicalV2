                ...
                <div class="tab-content">
                  ...
                  {{--         <tr>
                        ...
                        <footer>
                          ...
                          <div class="btn-group pull-right">
                              <div class="col-sm-3">
                                  <label class="badge bg-default">Labs Results Ready</label> 
                             <select name="requested_test[]" id="requested_test" style="width:100%" multiple data-placeholder="Muscu"  >
                             {{-- <option value="@foreach($tests as $val) {{ $val->investigation }}@endforeach" selected > @foreach($tests as $val) {{ $val->investigation }}@endforeach </option> --}}
                               @foreach($tests as $val)
                             <option  value="{{ $val->investigation }}">{{ $val->investigation }}</option>
                               @endforeach
                                 </select>    
                               </div>
                          </div>
